                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered" style="margin-top:20px;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$imgae->imgID}}</td>
                                        <td> <img width="200" src="{{asset('public/uploads/product/'.$imgae->imgName)}}" class="thumbnail"></td>



                                        <td>
                                            <a onclick="return confirm('Bạn có chắn muốn xóa?')" href="{{URL::to('/delete-multi-image-'.$imgae->imgID)}}" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
