    ...
    <div class="col-xs-12 col-md-8 col-lg-8">
        <div class="panel panel-primary">
            <div class="panel-heading">
                Thêm danh mục y khoa
            </div>
            <form action="{{URL::to('/save-category-skill')}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                @if(isset($categoryById) )
                <div class="panel-body">
                    <div class="form-group">
                        <label>Tên danh mục:</label>
                        <input value="{{$categoryById->name}}" id="title" onkeyup="ChangeToSlug();" type="text" name="nameCategory" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows=8 class="display_block" name="category_keywords">{{$categoryById->category_keywords}}</textarea>
                    </div>
                   
                    <div class="form-group">
                        <label>Hiển thị</label>
                        <select name="statusCategory" class="form-control">
                            @if($categoryById->status == 1)
                    ...
                    <input type="hidden" name="id" value="{{$categoryById->id }}" class="btn btn-primary">
