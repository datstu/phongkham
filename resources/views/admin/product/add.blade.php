    ...
    <div class="col-xs-12 col-md-12 col-lg-12">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category" class="form-control">
                            ...
                            <option value="{{$value->category_id}}" @if($ProductById->catID == $value->category_id)
                                selected
                                @endif
                    ...
                    <div class="form-group">
                        ...
                        <select name="brand" class="form-control">
                            ...
                            <option value="{{$value->brand_id }}" @if($ProductById->brandID == $value->brand_id )
                                selected
                                @endif
                    ...
                    <div class="form-group">
                        ...
                        <img id="avatar" class="thumbnail" width="100" src="{{asset('public/uploads/product/'.$ProductById->image)}}">
        ...
        ">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <label>Tên sản phẩm:</label>
                            <input required type="text" name="nameProduct" class="form-control" placeholder="Tên sản phẩm...">
                        </div>
                        <div class="form-group">
                            <label>Mô tả ngắn:</label>
